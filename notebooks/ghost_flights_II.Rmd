...
p3 = data.to.plot %>% 
  ...
  scale_colour_manual(values = mycolors) +
  coord_fixed(ratio = 1) +
  facet_grid(~factor(reporting_month_year, levels=c("Aug-2020", "Sep-2020", "Oct-2020", "Nov-2020")))
...
p7 = data.to.plot %>% 
  ...
  ggplot(data=., aes(x=reporting_month_year, y=est.empty.planes, fill=airline_name)) +
  theme_bw() +
